...
export class LluaiIconPanelLeftRightDashed extends LluaiBaseIcon {
  getSvgIcon() {
...
customElements.define('lluai-icon-panel-left-right-dashed', LluaiIconPanelLeftRightDashed);
