...
export class LluaiIconAlignVerticalDistributeCenter extends LluaiBaseIcon {
  getSvgIcon() {
...
customElements.define('lluai-icon-align-vertical-distribute-center', LluaiIconAlignVerticalDistributeCenter);
