...
export class LluaiIconAlignVerticalDistributeEnd extends LluaiBaseIcon {
  getSvgIcon() {
...
customElements.define('lluai-icon-align-vertical-distribute-end', LluaiIconAlignVerticalDistributeEnd);
