...
export class LluaiIconPanelTopBottomDashed extends LluaiBaseIcon {
  getSvgIcon() {
...
customElements.define('lluai-icon-panel-top-bottom-dashed', LluaiIconPanelTopBottomDashed);
