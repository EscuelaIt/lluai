...
export class LluaiIconBriefcaseConveyorBelt extends LluaiBaseIcon {
  getSvgIcon() {
...
customElements.define('lluai-icon-briefcase-conveyor-belt', LluaiIconBriefcaseConveyorBelt);
