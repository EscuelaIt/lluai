...
export class LluaiIconAlignHorizontalDistributeCenter extends LluaiBaseIcon {
  getSvgIcon() {
...
customElements.define('lluai-icon-align-horizontal-distribute-center', LluaiIconAlignHorizontalDistributeCenter);
