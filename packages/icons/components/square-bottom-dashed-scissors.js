...
export class LluaiIconSquareBottomDashedScissors extends LluaiBaseIcon {
  getSvgIcon() {
...
customElements.define('lluai-icon-square-bottom-dashed-scissors', LluaiIconSquareBottomDashedScissors);
