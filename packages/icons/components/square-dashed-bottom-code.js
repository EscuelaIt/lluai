...
export class LluaiIconSquareDashedBottomCode extends LluaiBaseIcon {
  getSvgIcon() {
...
customElements.define('lluai-icon-square-dashed-bottom-code', LluaiIconSquareDashedBottomCode);
