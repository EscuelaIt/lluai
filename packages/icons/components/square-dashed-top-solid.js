...
export class LluaiIconSquareDashedTopSolid extends LluaiBaseIcon {
  getSvgIcon() {
...
customElements.define('lluai-icon-square-dashed-top-solid', LluaiIconSquareDashedTopSolid);
