...
export class LluaiIconAlignCenterHorizontal extends LluaiBaseIcon {
  getSvgIcon() {
...
customElements.define('lluai-icon-align-center-horizontal', LluaiIconAlignCenterHorizontal);
